        ...
        <div className="auth-card">
          ...
          <div className="auth-form-col">
            ...
            <div className="auth-social-row">
              <button className="auth-social-btn" aria-label="Sign up with Google" type="button">🔍</button>
              <button className="auth-social-btn" aria-label="Sign up with LinkedIn" type="button">in</button>
              <button className="auth-social-btn" aria-label="Sign up with X" type="button">𝕏</button>
            </div>
