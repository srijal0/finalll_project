    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .auth-image { background-size: cover; background-position: center; min-height: 560px; }
        .auth-form-col { padding: 56px 56px; display: flex; flex-direction: column; justify-content: center; }
        ...
        .auth-forgot { display: block; text-align: right; font-size: 12px; color: #4a7c59; text-decoration: none; margin-top: 8px; }
        ...
        .auth-submit {
          ...
          background: #1f3b22; color: #fff; border: none;
        ...
        .auth-divider { display: flex; align-items: center; gap: 12px; margin: 24px 0; color: #aaa; font-size: 11px; font-weight: 700; letter-spacing: 1px; }
        ...
        .auth-social-row { display: flex; justify-content: center; gap: 12px; margin-bottom: 28px; }
        ...
        .auth-legal { text-align: center; margin-top: 32px; font-size: 11px; color: #aaa; }
        ...
        <div className="auth-card">
          ...
          <div className="auth-form-col">
            ...
            <div className="auth-social-row">
              <button className="auth-social-btn" type="button" aria-label="Google">🔍</button>
              <button className="auth-social-btn" type="button" aria-label="LinkedIn">in</button>
              <button className="auth-social-btn" type="button" aria-label="X">𝕏</button>
            </div>
