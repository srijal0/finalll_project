    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fv-logo { font-size: 20px; font-weight: 800; color: #2d4a2d; text-decoration: none; }
        .fv-logo span { color: #7aad6a; }
        .fv-nav-links { display: flex; gap: 28px; list-style: none; }
        .fv-nav-links a { font-size: 13px; font-weight: 500; color: #555; text-decoration: none; }
        .fv-nav-links a:hover { color: #2d4a2d; }
        .fv-back { background: none; border: none; cursor: pointer; font-size: 13px; color: #666; font-weight: 500; display: flex; align-items: center; gap: 6px; }
        .fv-back:hover { color: #2d4a2d; }
        ...
        .fv-tab {
          background: none; border: none; padding: 9px 22px;
          font-size: 12px; font-weight: 700; letter-spacing: 1px; cursor: pointer;
          color: #aaa; border-bottom: 2px solid transparent; margin-bottom: -1px;
        ...
        .fv-add {
          ...
          padding: 7px 13px; border-radius: 6px; font-size: 11px;
      ...
      <nav className="fv-nav">
        <a href="/" className="fv-logo">Eco<span>Haven</span></a>
        ...
        <button className="fv-back" onClick={() => router.push("/shop")}>← Continue Shopping</button>
      </nav>
